defmodule Zorn.Accounts.Users do
  use Ecto.Schema
  ...
  defp maybe_validate_unique_username(changeset, opts) do
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:username, Zorn.Repo)
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:email, Zorn.Repo)
  ...
  @doc """
  A users changeset for updating user fields like gold.
  """
  def changeset(users, attrs) do
    users
    |> cast(attrs, [:gold, :username])
  ...
  """
  def valid_password?(%Zorn.Accounts.Users{hashed_password: hashed_password}, password)
